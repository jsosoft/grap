(function () {
	JSO.Client.Timer = function (context, process, fps, delay) {
		this.metatype = 'timer';
		this.requestId = 0;
		this.timeoutId = 0;
		this.startTime = 0;
		...
		this.start = function (_this) {
			...
			if (_this.delay > 0 && Date.now() - _this.startTime > _this.delay) _this.destroy();
			...
			this.timeoutId = setTimeout(function () {
				...
				if (!_this.delay) _this.requestId = requestAnimationFrame(function () { _this.process.apply(_this.context, [arguments[0], _this]); });
