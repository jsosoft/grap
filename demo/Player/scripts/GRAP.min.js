...
(function(){var initializing=false,fnTest=/xyz/.test(function(){xyz;})?/\b_super\b/:/.*/;var grapClass=namespace('JSO.Client.Class');JSO.Client.Class=function(){};JSO.Client.Class.prototype.clonable=true;JSO.Client.Class.extend=function(prop){var _super=this.prototype;initializing=true;var prototype=new this();initializing=false;for(var name in prop){prototype[name]=typeof prop[name]=='function'&&typeof _super[name]=='function'&&fnTest.test(prop[name])?(function(name,fn){return function(){var tmp=this._super;this._super=_super[name];var ret=fn.apply(this,arguments);this._super=tmp;return ret;};})(name,prop[name]):prop[name];}
...
this.prevrotationmod=this.rotationmod;var parentRot=this.parent.rotation;var rowmap=this.rowmap;var rowthresh=this.rowthresh;if(this.autoRowCalc){if(this.parent.fixedRotation===false||this.parent.fixedRotation==='false'||this.parent.fixedRotation===0){var rowIndex=Math.round(parentRot/rowthresh)-1;rowIndex=!rowmap.length?0:rowIndex>rowmap.length?0:rowIndex<0?rowmap.length-1:rowIndex;this.currentrow=(rowmap instanceof Array&&rowmap.length>0?rowmap[rowIndex]:0);}else{if(this.parent&&this.parent.orientation){this.rowIndex=this.parent.orientation.x==1&&this.parent.orientation.y==0?0:this.parent.orientation.x==1&&this.parent.orientation.y==1?2:this.parent.orientation.x==0&&this.parent.orientation.y==1?1:this.parent.orientation.x==-1&&this.parent.orientation.y==1?3:this.parent.orientation.x==-1&&this.parent.orientation.y==0?4:this.parent.orientation.x==-1&&this.parent.orientation.y==1?5:this.parent.orientation.x==-1&&this.parent.orientation.y==-1?6:this.parent.orientation.x==0&&this.parent.orientation.y==-1?7:0;this.currentrow=this.rowmap[this.rowIndex];}}}
