...
(function( $, window, undefined ) {
	...
	$.event.special.swipe = {
		...
		//**Added js 20121221**
		horizontalDistanceVThreshold: 200,  // Swipe horizontal displacement must be less than this.

		verticalDistanceVThreshold: 30,  // Swipe vertical displacement must be more than this.
		...
		handleSwipe: function( start, stop ) {
			if ( stop.time - start.time < $.event.special.swipe.durationThreshold &&
				...
				Math.abs( start.coords[ 0 ] - stop.coords[ 0 ] ) < $.event.special.swipe.horizontalDistanceVThreshold &&
				Math.abs( start.coords[ 1 ] - stop.coords[ 1 ] ) > $.event.special.swipe.verticalDistanceVThreshold ) {
